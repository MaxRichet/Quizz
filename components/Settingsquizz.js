...
export default class Settingsquizz extends React.Component{
    ...
    render(){
        return(
            <View>
                <Text style={style.title}>Choix de la difficulté</Text>
                <Picker
                ...
                <Text style={style.title}>Choix du thème</Text>
                <Picker
                ...
                <Button style={style.button} title='Commencer le quizz' onPress={ () => this.submit() } />
            </View>
        )
    }
}